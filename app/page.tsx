...
export default function Home() {
  ...
  return <main>
    ...
    <section className="menu-section patterned" id="menu"><div className="section-head"><div><p className="eyebrow">Tap around. Find your thing.</p><h2>THE MENU</h2></div><p>Use the filters, open any dish for details, and build your order before you even sit down.</p></div>
      ...
      <section className="margarita-manifesto"><div className="marg-copy"><p className="eyebrow">The bar is not an afterthought</p><h3>THE BEST MARGS<br/>IN TORONTO.</h3><p>Yeah, we said it. You gonna argue with us? They’re $10 during Happy Hour. Come try.</p><button onClick={()=>setGroup("Margaritas")}>Meet all ten margaritas →</button></div><div className="marg-work"><article><span>48 HRS → 2 WEEKS</span><strong>House-infused tequila</strong><p>Real fruit, herbs and chilis. Time does the work. We just obsess over it.</p></article><article><span>REAL FRUIT ZEST</span><strong>Our own triple sec</strong><p>Made in-house to use the good stuff and waste less of it.</p></article><article><span>UP TO 7 DAYS</span><strong>Infused salts & rims</strong><p>Dried slowly, then ground by hand because apparently we enjoy making life difficult.</p></article><article><span>FRESH, NOT FAKE</span><strong>Syrups, liqueurs & aguas frescas</strong><p>Made here from actual fruit. Wild concept, we know.</p></article></div><div className="marg-stamp">SERIOUS BAR.<br/>NOT-SO-SERIOUS PEOPLE.</div></section>
