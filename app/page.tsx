...
export default function Home() {
  ...
  return <main>
    ...
    <nav className="mobile-nav" aria-label="Mobile navigation"><a href="#menu" className="mobile-nav-item"><span className="mobile-nav-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 6h14M5 12h14M5 18h9"/></svg></span><span className="mobile-nav-label">Menu</span></a><a href="#specials" className="mobile-nav-item"><span className="mobile-nav-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M12 3v3M12 18v3M3 12h3M18 12h3"/><circle cx="12" cy="12" r="4"/></svg></span><span className="mobile-nav-label">Specials</span></a><button type="button" className="mobile-nav-book" onClick={openReservation}><span className="mobile-nav-book-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M7 4v3M17 4v3M5 9h14M6 6h12a1 1 0 0 1 1 1v12H5V7a1 1 0 0 1 1-1Z"/><path d="m9 14 2 2 4-5"/></svg></span><span>Book</span></button><a href="https://order.store/store/la-chingada-1242-dundas-st-w/GAGuGYkPR1WXgc_LV9VxDQ" target="_blank" rel="noreferrer" className="mobile-nav-item"><span className="mobile-nav-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M6 7h12l-1 11H7L6 7Z"/><path d="M9 7a3 3 0 0 1 6 0"/></svg></span><span className="mobile-nav-label">Order</span></a></nav>
  </main>
}
